...
import { Info, ArrowRight, LucideIcon } from "lucide-react";
...
export const ServiceTile = ({ title, description, Icon, to, className = "" }: ServiceTileProps) => (
  <motion.div
    variants={{
    ...
    className={`bg-gradient-to-br from-white via-roofing-cream to-roofing-beige backdrop-blur-sm rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8 transform transition-all duration-300 hover:shadow-2xl border border-roofing-orange/20 relative group ${className}`}
  >
