...
export const CalculatorSection = ({ showCalculator }: CalculatorSectionProps) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[345px] mx-auto relative">
        {/* Decorative elements */}
        ...
        <motion.div
          className="relative bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500"
        ...
        >
          ...
          <div className="relative">
            ...
            <iframe
              ...
              className="w-full aspect-[0.53] h-[650px] border-none rounded-lg shadow-lg relative z-10"
