  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[12rem] md:pt-[22rem] pb-12">
            ...
            <div className="flex justify-center gap-4 md:gap-8 mb-12 pointer-events-auto">
              {socialLinks.map(({ Icon, href, label, delay }, index) => (
                <motion.button
                  ...
                  className="p-2 md:p-4 bg-roofing-beige rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group active:bg-roofing-orange/20"
                >
