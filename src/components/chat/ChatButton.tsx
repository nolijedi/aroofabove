...
export const ChatButton = ({ onClick, isHammering }: ChatButtonProps) => {
  return (
    <Button
      onClick={onClick}
      className="fixed bottom-6 right-6 w-[68px] h-[68px] rounded-full p-0 bg-roofing-orange/80 hover:bg-roofing-orange-dark shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center z-50 group"
